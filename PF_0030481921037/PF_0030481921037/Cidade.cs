    ...
    class Cidade
    {
        ...
        public int Salvar()
        {
            ...
            { 
                ...
                int nReg;
                mycommand = new SqlCommand("INSERT INTO TBCIDADE VALUES (@nome_cidade,@uf_cidade)",
        ...
        public int Alterar()
        {
            ...
            try
            {
                SqlCommand mycommand; 
                int nReg = 0;
                mycommand = new SqlCommand("UPDATE TBCIDADE SET nome_cidade = @nome_cidade ," +
                    "uf_cidade = @uf_cidade WHERE id_cidade = @id_cidade", frmPrincipal.conexao);
